...
int main(void) {
    ...
    UChar key_English[] = { 'E', 'n', 'g', 'l', 'i', 's', 'h', 0 };
    UChar key_French[] = { 'F', 'r', 'e', 'n', 'c', 'h', 0 };
    UChar key_one[] = { 'o', 'n', 'e', 0 };
    UChar key_two[] = { 't', 'w', 'o', 0 };
    UChar key_alice[] = { 'a', 'l', 'i', 'c', 'e', 0 };
    UChar key_bob[] = { 'b', 'o', 'b', 0 };
    UChar key_charles[] = { 'c', 'h', 'a', 'r', 'l', 'e', 's', 0 };
